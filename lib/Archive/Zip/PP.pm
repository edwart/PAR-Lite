...
sub computeCRC32 {
	...
	return Compress::Zlib::Perl::crc32( $data, $crc );
}
...
This module uses the L<Compress::Zlib::Perl> library to read and write the
...
This is a utility function that uses the Compress::Zlib::Perl CRC
...
size used for Compress::Zlib::Perl. You must call setChunkSize()
...
L<Compress::Zlib::Perl>, L<Archive::Tar>, L<Archive::Extract>
